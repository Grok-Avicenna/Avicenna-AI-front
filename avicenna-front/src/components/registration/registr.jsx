                    ...
                    <div className="flex flex-col items-center mt-24 max-md:m-0">
                        ...
                        <form className="mt-16 flex flex-col gap-2" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <label htmlFor="inputEmail" className="cursor-pointer">
                                ...
                                <input type="email" id="inputEmail" className='input-regist inp-additional' {...register("email", { required: true })} />
                                {errors.email && <span className="text-red-500 ">Email is required</span>}
                            </label>
                            <label htmlFor="inputPassword" className="cursor-pointer">
                                <p className="mt-1 max-md:text-base">Password</p>
                                <input type="password" id="inputPassword" className='input-regist inp-additional' {...register("password", { required: true })} />
                                {errors.password && <span className="text-red-500 ">Password is required</span>}
                            </label>
                            <div className='flex gap-2'>
                                <NavLink to={'/regisfordoc'} className="w-full border-black border-2 text-black h-14 rounded-3xl mt-16 max-md:h-12 max-md:bg-white max-md:text-black text-center pt-3">
                                    <button type="submit" >I'm doctor</button>
                                </NavLink>
